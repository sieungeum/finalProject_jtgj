...
<body>
	...
	<section class="page-section" id="contact">
        ...
        <div class="container pt-5">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">건의사항 수정</h2>
            <!-- Icon Divider-->
            ...
            <div class="dFjcC marT30">
                <div class="col-lg-8 col-xl-7">
                	...
                	<form id="faqWriteForm" action="${pageContext.request.contextPath }/faqEditDo" method="POST">
	                    ...
	                    <div class="mb-5">
	                         <textarea id="smartEditor" class="form-control" name="faqContent" >${faq.faqContent }</textarea>
	                    </div>               
