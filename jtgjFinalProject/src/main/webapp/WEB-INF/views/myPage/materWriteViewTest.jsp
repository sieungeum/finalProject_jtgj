				...
				<div class="sb-sidenav-menu">
					<div class="nav"
						...
						<c:if
							...
							<a class="nav-link" style="color: white; padding-top: 30px;"
								href="${pageContext.request.contextPath }/promotion"> 홍보 </a>
						</c:if>
						<c:if
						...
						<div class="col-xl-4 col-lg-5">
							<div class="card mb-4" style="padding-bottom: 26px;">
								...
								<div class="card-body">
									...
									<div class="d-flex justify-content-end mar-buttom mt-5">
										<button class="btn btn-primary btn-xl m-right me-2" style="width:50%;" type="submit">등록</button>
										<a class="btn btn-primary btn-xl a-sor" style="width:50%;" href="${pageContext.request.contextPath}/adminPage">돌아가기</a>
									</div>
								</div>
							</div>
						</div>
