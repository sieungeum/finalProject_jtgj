...
<body>
    ...
    <div class="custom-container">
        <div class="w-100" style="border-bottom:1px solid black; padding-bottom:3%;"><h1>아이디/비밀번호 찾기</h3></div>
        
		<div style="padding-top:3%;padding-bottom:2%;"><h5 style="font-size:13px;font-weight:bolder;">가입한 아이디와 비밀번호를 잊으셨습니까?</h5></div>
		
		<div class="d-flex">
			<div class="w-50" style="display:flex;flex-direction:column;border:1px solid #CCCCCC;margin-right:1%;">
				<div style="display:flex; justify-content:center; align-items:center;">
					<p style="font-size:20px;padding-top:10%;padding-bottom:7%;font-weight:500;">개인회원</p>
				</div>
				<div class="d-flex" style="border-top:1px solid #CCCCCC;">
					<div class="w-50 find-id-btn" style="text-align:center;font-size:15px;padding-top:3%;padding-bottom:3%;border-right:1px solid #CCCCCC">
						<a style="color:black;" href="${pageContext.request.contextPath }/findPersonalIdView">아이디 찾기</a>
					</div>
					<div class="w-50 find-pw-btn" style="text-align:center;font-size:15px;padding-top:3%;padding-bottom:3%;">
						<a style="color:black;" href="${pageContext.request.contextPath }/findPersonalPwView">비밀번호 찾기</a>
					</div>
				</div>
			</div>
			
			<div class="w-50" style="display:flex;flex-direction:column;border:1px solid #CCCCCC;margin-left:1%;">
				<div style="display:flex; justify-content:center; align-items:center;">
